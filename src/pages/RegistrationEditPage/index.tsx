...
export function RegistrationEditPage() {
			...
			.then((responses) => {
			  ...
			  api.get(`registration/${myParam}`)
                    .then((response) => {
                        ...
                        setValue(
                            "event_id",
                            response.data.response.event.id
                        );
                    })
                    .catch((error) => {
                        setOpenToast(true);
	...
	const editRegistration: SubmitHandler<registrationFormTypeValues> =  (
		formValues
	) => {
		
		setIsLoadingButton(true);

		api.put(`/registration/${myParam}`, {
	...
	return (
		<ContentBar>
			<FormPlanRegisterPage>
				...
				<form onSubmit={handleSubmit(editRegistration)}>
